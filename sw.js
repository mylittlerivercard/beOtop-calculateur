/* beOtop Companion — Service Worker v1.0 */
const CACHE_NAME = 'beotop-companion-v1';
const PRECACHE_URLS = [
  '/companion_pwa',
...
self.addEventListener('fetch', event => {
  ...
  if (url.hostname === 'beotop-api.onrender.com') {
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(self.registration.showNotification(d.title || 'beOtop Companion', { body: d.body || '', icon: '/static/icons/icon-192.png', data: { url: d.url || '/companion_pwa' } }));
});
