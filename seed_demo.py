...
# Poids d'usage par atelier (somme = 100)
ATELIER_WEIGHTS = [28, 18, 14, 12, 10, 8, 6, 4]
...
DEPT_ATELIER_PREF = {
    'RH':          [0, 3, 6],   # Méridienne, Sieste, Méditation
    'Direction':   [0, 1, 7],   # Méridienne, Bain lumière, Massage
    'Marketing':   [2, 4, 5],   # Stretching, Relaxation, Cohérence
    'Commercial':  [0, 5, 3],   # Méridienne, Cohérence, Sieste
    'Finance':     [1, 6, 3],   # Bain lumière, Méditation, Sieste
    'IT':          [4, 2, 5],   # Relaxation, Stretching, Cohérence
    'Juridique':   [1, 0, 6],   # Bain lumière, Méridienne, Méditation
    'Opérations':  [2, 7, 4],   # Stretching, Massage, Relaxation
    'Qualité':     [5, 1, 3],
    'R&D':         [6, 4, 0],
    'Communication':[3, 2, 1],
}
