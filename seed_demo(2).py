...
# Noms exacts tels que saisis dans le kiosque (image kiosk)
ATELIERS = [
    'Méridienne P127',
    'Cocon de Sieste',
    'Neurosonic Lit',
    'Siège Massant 0 Gravité',
    'Siège Massant Shiatsu',
    'Transat 127',
    'Siège Lecture',
    "Bol d'Air Jacquier",
    'Bain de Lumière Rouge',
    'Photobiomodulation',
    'Sensosphère',
    'Lunettes Psio',
]

# Poids d'usage calés sur les taux d'occupation réels des capteurs PIR
# meridienne 22.8%, cocon 22.3%, neurosonic 18.9%, siege-massant 15.6%+11.7%,
# transat 15.8%, siege-lecture 11.1%, bol-air 5.4%, autres distribués
ATELIER_WEIGHTS = [23, 20, 16, 12, 10, 12, 8, 4, 5, 4, 3, 3]
...
DEPT_ATELIER_PREF = {
    'RH':         [0, 1, 8],   # Méridienne, Cocon Sieste, Bain Lumière
    'Finance':    [1, 2, 5],   # Cocon Sieste, Neurosonic, Transat
    'Marketing':  [0, 10, 11], # Méridienne, Sensosphère, Lunettes Psio
    'IT':         [2, 9, 3],   # Neurosonic, Photobiomodulation, Siège Massant 0G
    'Direction':  [0, 5, 4],   # Méridienne, Transat, Siège Massant Shiatsu
    'Commercial': [0, 1, 3],   # Méridienne, Cocon Sieste, Siège Massant 0G
    'Operations': [4, 6, 7],   # Siege Massant Shiatsu, Siege Lecture, Bol Air
}
    ...
    for d in get_workdays():
        ...
        for at_idx, atelier in enumerate(ATELIERS):
            ...
            for _ in range(n_at_sessions):
                ...
                if atelier in ('Cocon de Sieste', 'Neurosonic Lit', 'Bain de Lumière Rouge'):
                    duree_min, duree_max = 15, 35
                elif atelier in ("Bol d'Air Jacquier", 'Lunettes Psio', 'Sensosphère'):
                    duree_min, duree_max = 8, 20
                else:
                    duree_min, duree_max = 10, 28
